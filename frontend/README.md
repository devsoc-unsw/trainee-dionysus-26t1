...
Hello dionysus disciples first you must install bun:
...
And to start the frontend server, run:
...
(Below is the README that comes with Vite. I have never read it before so u can probably skip it lol)
